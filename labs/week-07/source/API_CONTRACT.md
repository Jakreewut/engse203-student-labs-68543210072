...
| **ผู้จัดทำ** | `จักรีวุฒน์ สุขคำเมือง 68543210072-3` |
| **วันที่ปรับปรุงล่าสุด** | `18/09/2026` |
...
```json
{
  "error": "ข้อมูลคำร้องไม่ถูกต้อง",
  "details": [
    "สถานะต้องเป็น pending, in-progress หรือ completed เท่านั้น"
  ]
}
```
...
**ทำอะไร** `ลบรายการคำร้องที่ตรงกับรหัสที่ระบุออกจากระบบอย่างถาวร`
...
|---|---|---|:---:|
| 1.0.0 | `11/09/2026` | เวอร์ชันแรก — GET, POST, DELETE | — |
| 2.0.0 | `18/09/2026` | เพิ่ม `PUT /api/requests/:id` และ CORS | ไม่ |
| `<...>` | `<...>` | `<...>` | `<...>` |

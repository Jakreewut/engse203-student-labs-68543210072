...
**ชื่อ–รหัส:** __จักรีวุฒน์ สุขคำเมือง___ **วันที่ทดสอบ:** __13/09/69__
...
|---|---|---|---|---|---|---|
| 1 | GET | `/` | — | 200 | 200 ok | ✅ |
| 2 | GET | `/api/requests` | requests | 200 | 200 ok | ✅ |
| 3 | GET | `/api/requests/REQ-001` | REQ-001 | 200 | 200 ok | ✅ |
| 4 | GET | `/api/requests/REQ-999` | REQ-999 | |  404 Not Found | ✅ |
| 5 | POST | `/api/requests` | ข้อมูลครบถูกต้อง | | 400 Bad Request| ✅ |
| 6 | POST | `/api/requests` | `{"requesterName":"x"}` | | 400 | ✅ |
| 7 | DELETE | `/api/requests/REQ-003` | ELETE REQ-003 | | 204 | ✅ |
| 8 | DELETE | `/api/requests/REQ-999` | ELETE REQ-999 | 404 Not Found | | ✅ |
| 9 | GET | `/api/unknown` | GET unknown | | 404 Not Found | ✅ |
